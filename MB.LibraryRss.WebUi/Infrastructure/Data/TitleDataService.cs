namespace MB.LibraryRss.WebUi.Infrastructure.Data
{
  ...
  public class TitleDataService : ITitleDataService
  {
    ...
    public TitleDataService(UnitOfWork uow, IMappingEngine mapper)
    {
      this.uow = uow;
      this.mapper = mapper;
    }
    ...
    public DateTime? GetDateFeedLastUpdated()
    {
      return this.Feeds.GetMaxFeedLastUpdated();
    }

    public DateTime? GetDateDataLastRefreshed()
    {
      return this.Feeds.GetMaxInserted();
    }
  }
}
